...
3. Rode o comando unificado de início (recomendado):
```bash
npx aiox-core start
```
4. Ative 1 agente e confirme o greeting.
5. Rode 1 comando inicial (`*help` ou equivalente) para validar first-value.
